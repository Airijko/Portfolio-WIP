  ...
  return (
    <section className="p-12 h-full">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="md:grid md:grid-cols-2 pt-5 min-h-[500px]">
          <div className="flex flex-col items-center">
            ...
            <p className="flex flex-col font-grotesk mt-2">
              <span>
                I've always wanted to become a programmer in high school, but
                the school I attended, Faith Academy, didn't have such a course.
            ...
            <div>
              ...
              <p className="flex flex-col text font-grotesk mt-2">
                <span>
                  ...
                  online name "Airijko". Which is a pun for "Aray ko" which
